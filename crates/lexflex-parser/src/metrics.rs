...
pub struct ParseMetrics {
    ...
    pub application_attempt_count: usize,
    pub rejected_application_count: usize,
    pub generated_derivation_count: usize,
    pub merged_derivation_count: usize,
    pub deduplicated_derivation_count: usize,
    pub complete_candidate_count: usize,
    pub complete_rejection_count: usize,
    pub complete_semantic_count: usize,
    pub max_cell_size: usize,
    pub max_derivation_depth: usize,
    pub max_semantic_nodes: usize,
    pub max_total_derivations_observed: usize,
}
